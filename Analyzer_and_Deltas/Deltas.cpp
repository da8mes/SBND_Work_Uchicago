/* Deltas.cpp
 *
 *  * Written by: D. Belayneh <dawit@uchicago.edu>, 08/12/2019
 *
 *
 */
...
// function to be used by analysis module to retrieve theory expectations
// for deltas via a histtogram given a TTree with signature (N, Eo, x) 
// where N is number of events, Eo is initial energy and x is activeDist in TPC
// TTree is expected to use [Gev] and [cm]
void computeDeltas(TH1F* deltas, TTree* muonStats)
{

	TTreeReader reader(muonStats);
